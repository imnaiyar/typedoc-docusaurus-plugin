...
> [!IMPORTANT]  
> This is a fork of
> [docusaurus-plugin-typedoc-api](https://github.com/milesj/docusaurus-plugin-typedoc-api). The main
> notable difference between this plugin is that it display parameters in a table rather than a list
> so it looks more structured, more changes may be added later, but credits to the original author.
